    ...
    ui(new Ui::Settings)
{
    ...
    ui->waterImg->setPixmap(QPixmap::fromImage(QImage(full_path + "/sandbox_mat/terrain/water.bmp")));
    ui->sandImg->setPixmap(QPixmap::fromImage(QImage(full_path + "/sandbox_mat/terrain/sand.bmp")));
    ui->grassImg->setPixmap(QPixmap::fromImage(QImage(full_path + "/sandbox_mat/terrain/grass.bmp")));
    ui->stoneImg->setPixmap(QPixmap::fromImage(QImage(full_path + "/sandbox_mat/terrain/stone.bmp")));
    ui->snowImg->setPixmap(QPixmap::fromImage(QImage(full_path + "/sandbox_mat/terrain/snow.bmp")));

    ui->imgSkyboxLeft->setPixmap(QPixmap::fromImage(QImage(full_path + "/sandbox_mat/sea/left.bmp")));
    ui->imgSkyboxRight->setPixmap(QPixmap::fromImage(QImage(full_path + "/sandbox_mat/sea/right.bmp")));
    ui->imgSkyboxTop->setPixmap(QPixmap::fromImage(QImage(full_path + "/sandbox_mat/sea/top.bmp")));
    ui->imgSkyboxBottom->setPixmap(QPixmap::fromImage(QImage(full_path + "/sandbox_mat/sea/bottom.bmp")));
    ui->imgSkyboxFront->setPixmap(QPixmap::fromImage(QImage(full_path + "/sandbox_mat/sea/front.bmp")));
    ui->imgSkyboxBack->setPixmap(QPixmap::fromImage(QImage(full_path + "/sandbox_mat/sea/back.bmp")));
...
{
    GlobalSettings::getInstance()->setMinHeight(470);
    Scene::getInstance()->terrain->stream->setMinDepth(470);

    GlobalSettings::getInstance()->setMaxHeight(700);
    Scene::getInstance()->terrain->stream->setMaxDepth(700);
    ...
    Scene::getInstance()->terrain->setWaterTexture(full_path.toStdString() + "/sandbox_mat/terrain/water.bmp");
    Scene::getInstance()->terrain->setSandTexture(full_path.toStdString() + "/sandbox_mat/terrain/sand.bmp");
    Scene::getInstance()->terrain->setGrassTexture(full_path.toStdString() + "/sandbox_mat/terrain/grass.bmp");
    Scene::getInstance()->terrain->setStoneTexture(full_path.toStdString() + "/sandbox_mat/terrain/stone.bmp");
    Scene::getInstance()->terrain->setSnowTexture(full_path.toStdString() + "/sandbox_mat/terrain/snow.bmp");

    Scene::getInstance()->skybox->setLeft(full_path.toStdString() + "/sandbox_mat/sea/left.bmp");
    Scene::getInstance()->skybox->setRight(full_path.toStdString() + "/sandbox_mat/sea/right.bmp");
    Scene::getInstance()->skybox->setTop(full_path.toStdString() + "/sandbox_mat/sea/top.bmp");
    Scene::getInstance()->skybox->setBottom(full_path.toStdString() + "/sandbox_mat/sea/bottom.bmp");
    Scene::getInstance()->skybox->setFront(full_path.toStdString() + "/sandbox_mat/sea/front.bmp");
    Scene::getInstance()->skybox->setBack(full_path.toStdString() + "/sandbox_mat/sea/back.bmp");
    ...
    ui->flip_hor->setChecked(false);
    ui->flip_vert->setChecked(false);
...
void Settings::setWaterTexture()
{
    ...
    QString filename = QFileDialog::getOpenFileName(this,
                                            tr("Open Image"), full_path, tr("Image Files (*.bmp)"));
