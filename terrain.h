...
public:
    ...
    void setGrassTexture(std::string filename);
    void setSandTexture(std::string filename);
    void setWaterTexture(std::string filename);
    void setStoneTexture(std::string filename);
    void setSnowTexture(std::string filename);
