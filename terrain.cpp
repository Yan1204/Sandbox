...
void Terrain::setup()
{
    ...
    terrainTechnique = new ShaderTechnique(full_path.toStdString() + "/shaders/terrain.vert", full_path.toStdString() + "/shaders/terrain.frag" );
    ...
    else
    {
        ...
        stream = new Filestream(full_path.toStdString() + "/sandbox_mat/map.raw", 320, 240);
    }
    ...
    grass     =  new Texture2D (full_path.toStdString() + "/sandbox_mat/terrain/grass.bmp", 0 );
    sand      =  new Texture2D (full_path.toStdString() + "/sandbox_mat/terrain/sand.bmp",  1 );
    stone     =  new Texture2D (full_path.toStdString() + "/sandbox_mat/terrain/stone.bmp", 2 );
    snow      =  new Texture2D (full_path.toStdString() + "/sandbox_mat/terrain/snow.bmp",  3 );
    water_tex =  new Texture2D (full_path.toStdString() + "/sandbox_mat/terrain/water.bmp", 4 );
    reflection = new Texture2D (full_path.toStdString() + "/sandbox_mat/terrain/reflection.bmp", 6);
...
void Terrain::setGrassTexture(std::string filename)
{
    grass->setImage(strdup(filename.c_str()));
}

void Terrain::setSandTexture(std::string filename)
{
    sand->setImage(strdup(filename.c_str()));
}

void Terrain::setStoneTexture(std::string filename)
{
    stone->setImage(strdup(filename.c_str()));
}

void Terrain::setWaterTexture(std::string filename)
{
    water_tex->setImage(strdup(filename.c_str()));
}

void Terrain::setSnowTexture(std::string filename)
{
    snow->setImage(strdup(filename.c_str()));
}
